...
class InformaationScreen extends StatefulWidget {
  const InformaationScreen({super.key});

  @override
  State<InformaationScreen> createState() => _InformaationScreenState();
}

class _InformaationScreenState extends State<InformaationScreen> {
