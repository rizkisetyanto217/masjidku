      ...
      child: GridView.count(
        ...
        children: [
          _menuItem(
            ...
            Icons.info,
            "Informasi",
            onTap: () => GoRouter.of(context).go('/masjid/information'),
          ),
          _menuItem(
            context,
            Icons.receipt_long,
            "Laporan Keuangan",
            onTap: () => GoRouter.of(context).go('/masjid/financial-report'),
          ),
          _menuItem(
            context,
            Icons.people,
            "Absensi & Belajar",
            onTap: () => GoRouter.of(context).go('/masjid/absence-study'),
          ),
          _menuItem(
            context,
            Icons.calendar_month,
            "Jadwal Kajian",
            onTap: () => GoRouter.of(context).go('/masjid/agenda'),
          ),
          _menuItem(
            context,
            Icons.event_note_sharp,
            "Acara",
            onTap: () => GoRouter.of(context).go('/masjid/event'),
          ),
          _menuItem(
            context,
            Icons.workspace_premium,
            "Sertifikat",
            onTap: () => GoRouter.of(context).go("/masjid/certificate"),
          ),
          _menuItem(
            context,
            Icons.person,
            "Profil",
            onTap: () => GoRouter.of(context).go('/masjid/profile'),
          ),
        ],
      ),
    );
