...
class MyActivityLessonIncomeScreen extends StatefulWidget {
  const MyActivityLessonIncomeScreen({super.key});

  @override
  State<MyActivityLessonIncomeScreen> createState() =>
      _MyActivityLessonIncomeScreenState();
}

class _MyActivityLessonIncomeScreenState
    extends State<MyActivityLessonIncomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Kajian Mendatang"),
        leading: IconButton(
